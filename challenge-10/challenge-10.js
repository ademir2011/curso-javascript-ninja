...
(function(){
    ...
    */
    var isOperatorValid = function( param ){
        return param === '+' ? true : param === '-' ? true : param === '*' ? true : param === '/' ? true : param === '%' ? true : false;
    };
    ...
    */
    var calculator = function(param){
        return !isOperatorValid(param) ? false : function(param1, param2){ return typeof param1 !== 'number' || typeof param2 !== 'number' ? false : operation[param](param1, param2); };
    };
    ...
    */
    var showOperationMessage = function(param1, param2, param3){
    ...
    */
    console.log ( !sum ? showErrorMessage(operationSignal) : showOperationMessage(operationSignal, number1, number2) + sum(number1, number2) );
