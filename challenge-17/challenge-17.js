...
(function() {
  ...
  */
  ...
  console.log(
    text.replace(/Manuel Marques de Sousa/, "Ademir Bezerra da Silva Junior")
  );
  ...
  */
  ...
  console.log(text.replace(/brasileiro/, "Parnamirim"));
  ...
  */
  ...
  console.log(
    text.replace(/(O Centauro de Luvas)/g, function(capturaTotal) {
